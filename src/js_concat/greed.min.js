...
(function() {
  ...
  (function(Greed) {
    var AP, Deferred, OP, PENDING, REJECTED, RESOLVED, after, execute, flatten, forEach, hasOwn, indexOf, isArguments, isArray, reduce, slice, toString, wrap, _when;
    _g = Greed || {};
    AP = Array.prototype;
    OP = Object.prototype;
  ...
  */
  ...
  (function(Greed) {
    var AjaxCore, ajaxJSON, emptyFunc, _doc;
    _g = Greed;
